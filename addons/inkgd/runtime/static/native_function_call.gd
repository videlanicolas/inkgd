...
func int_binary_op_equals(x, y):                   x == y
func int_binary_op_greater(x, y):                  x > y
func int_binary_op_less(x, y):                     x < y
func int_binary_op_greater_than_or_equals(x, y):   x >= y
func int_binary_op_less_than_or_equals(x, y):      x <= y
func int_binary_op_not_equals(x, y):               x != y
func int_unary_op_not(x):                          x == 0

func int_binary_op_and(x, y):                      x != 0 && y != 0
func int_binary_op_or(x, y):                       x != 0 || y != 0
...
func float_binary_op_equals(x, y):                 if x == y
func float_binary_op_greater(x, y):                if x > y
func float_binary_op_less(x, y):                   if x < y
func float_binary_op_greater_than_or_equals(x, y): if x >= y
func float_binary_op_less_than_or_equals(x, y):    if x <= y
func float_binary_op_not_equals(x, y):             if x != y
func float_unary_op_not(x):                        if x == 0.0

func float_binary_op_and(x, y):                    if x != 0.0 && y != 0.0
func float_binary_op_or(x, y):                     if x != 0.0 || y != 0.0
...
func string_binary_op_equals(x, y):                if x == y
func string_binary_op_not_equals(x, y):            if x != y
...
func string_binary_op_has(x, y):                   y == "" || (y in x)
func string_binary_op_hasnt(x, y):                 !(y in x) && y != ""
...
func list_binary_op_equals(x, y):                  x.equals(y)
func list_binary_op_greater(x, y):                 x.greater_than(y)
func list_binary_op_less(x, y):                    x.less_than(y)
func list_binary_op_greater_than_or_equals(x, y):  x.greater_than_or_equals(y)
func list_binary_op_less_than_or_equals(x, y):     x.less_than_or_equals(y)
func list_binary_op_not_equals(x, y):              !x.equals(y)

func list_binary_op_and(x, y):                     x.size() > 0 && y.size() > 0
func list_binary_op_or(x, y):                      x.size() > 0 || y.size() > 0
...
func native_func_divert_targets_equal(d1, d2):     d1.equals(d2)
func native_func_divert_targets_not_equal(d1, d2): !d1.equals(d2)
